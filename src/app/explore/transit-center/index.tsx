...
const PHOTOS = [
    ...
    require('$/images/decoratives/transit-center/skyline-shuttle-sunset-banner.webp'),
            ...
            >
                <ThemedView className='flex gap-2'>
                    ...
                    <View className='flex flex-row'>
                        <ThemedText>You can find the <ThemedText className='font-bold'>Transit Center</ThemedText> south of</ThemedText>
                    ...
                    <View className='flex gap-4'>
                        ...
                        <LinkWrap href='/explore/transit-center/shuttle' className='w-full h-36 rounded-xl overflow-hidden border-2' lightColor='border-[#CC4040]/50' darkColor='border-[#CC4040]'>
                            ...
                            <View className='absolute bottom-1 px-2'>
                                <View className='flex flex-row items-center gap-x-2'>
                                    ...
                                    >The Skyline College Express Shuttle</Text>
                                </View>
                                <Text
                        ...
                        <View className='flex gap-2'>
                            <Image
                                ...
                                className='w-32 h-16'
                            />
                            <ThemedText><ThemedText className='font-bold'>SamTrans</ThemedText> serves three routes to Skyline College's <ThemedText className='font-bold'>Transit Center</ThemedText>. They all arrive in front of the bus stop shelter as seen in the image below.</ThemedText>
                            ...
                            <ThemedText>Be advised: Some buses rest at this stop shortly before resuming service. Wait for the bus to arrive at the stop before attempting to board.</ThemedText>
