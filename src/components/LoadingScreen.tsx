...
export default function LoadingScreen() {
    ...
    return (
        <ThemedView className='z-50 absolute flex items-center justify-center w-full h-full'>
            <Image source={require('$/images/loading-ripple.webp')} width={200} height={200} className='opacity-50' />
            ...
            <Image source={require('$/images/mono-icon.png')} tintColor={colorScheme === 'light' ? '#656565' : ''} width={100} height={100} className='absolute' />
        </ThemedView>
    )
}